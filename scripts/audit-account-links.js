...
const ROLE_PERMISSIONS = {
  ...
  Manager: ['admin.dashboard','admin.students','admin.courses','admin.online','admin.ondemand','admin.finance','admin.expenses','admin.receipts','admin.exams','admin.onlineExams','admin.monthlyPlanner','admin.announcements','admin.gamification','admin.prizeWheel','admin.logs','teacher.dashboard','teacher.online','teacher.attendance','teacher.students'],
  ...
  Finance: ['admin.dashboard','admin.students','admin.finance','admin.expenses','admin.receipts','admin.logs'],
